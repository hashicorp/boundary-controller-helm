...
| `bootstrapAdminAuthMethod.*` (enabled, runOnUpgrade, timeout/name fields, resources) | bootstrap job | [tests/unit/bootstrap-admin-job_test.yaml](../tests/unit/bootstrap-admin-job_test.yaml) |
